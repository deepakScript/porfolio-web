...
const ProfileImage = memo(() => (
    <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
        ...
        >
            ...
            <div className="absolute -inset-6 opacity-[25%] z-0 hidden sm:block bg-white">
            ...
            <div className="relative">
                <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
                    <div className="absolute inset-0 border-4 border-white rounded-full z-20 transition-all duration-700 group-hover:border-white/40 group-hover:scale-105" />
...
const StatCard = memo(({ icon: Icon, color, value, label, description, animation }) => (
    <div data-aos={animation} data-aos-duration={1000} className="relative group">
        <div className="relative z-10 bg-gray-800 backdrop-blur-lg rounded-2xl p-6 border border-white/10 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl h-full flex flex-col justify-between">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                >
                    <CountUp delay={1} end={value} duration={5} />+
                </span>
            </div>
            ...
            <div className="w-full mx-auto pt-8 sm:pt-12 relative">
                <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    <div className="space-y-6 text-center lg:text-left">
                        ...
                        >
                            I'm a dedicated front-end developer with over {YearExperience} years of experience in crafting responsive and user-centric web applications. My expertise lies in HTML, CSS, JavaScript, and modern frameworks like React. I thrive on transforming complex ideas into seamless digital experiences, ensuring both functionality and aesthetic appeal. Committed to continuous learning, I stay updated with the latest industry trends to deliver innovative solutions that exceed client expectations.
                        </p>
